      ...
      background-image: linear-gradient(rgba(4, 9, 30, 0.7), rgba(4, 9, 30, 0.7)), url(images/dslr.jpg);">
        ...
        <section class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <br>
                    <div class="text-center"><img src="images/photographer.jpg" class="rounded-circle d-inline img-fluid"
                            alt="">
                    </div>
                ...
                <div class="text-center">
                    ...
                    <div class="album py-0 bg-light">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm" style="background-color: #f6e5e5">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text ml3">"This studio is so dope! Great
                                                natural lighting and really cool space. They have good portions where to get
                                    ...
                                    <div class="card mb-4 shadow-sm" style="background-color: #f6e5e5">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text m13">“It's BEST place to implement any
                                                ideas for photo and video shooting. The location inspires to create unique
                                                work.
                                    ...
                                    <div class="card mb-4 shadow-sm" style="background-color: #f6e5e5;">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">“Toba was fantastic to deal with
                                                throughout. From our first call to the point when we had wrapped out - she
                                                was
                                                great. Thank you!”</p>
                                            <div class="d-flex justify-content-between align-items-center">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\faaiz\athree\resources\views/index.blade.php ENDPATH**/ ?>