            ...
            <div class="row row-signup" style="background-color:white;">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" class="form-control my-2 p-3" placeholder="First Name"
                                    pattern="[a-zA-Z]([0-9a-zA-Z]){2,10}" required value="Faaiz">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="email" class="form-control my-2 p-3" placeholder="Email"
                                    pattern="([a-zA-Z0-9_\-.]+)@([a-zA-Z0-9_\-.]+)\.([a-zA-Z]){2,7}" required value="faaiz@gmail.com">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="password" class="form-control my-2 p-3" placeholder="Password" id="pass1" value="123">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" class="form-control my-2 p-3" placeholder="+92-XXXXXXXXXX"
                                    pattern="((\+92)?(0092)?(92)?(0)?)(3)([0-9]{9})" required value="+923327411471">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <a href=""><button type="submit" class="btn1 mt-4 mb-5" onclick="passwordMatch()">Sign In</button>
                                </a>
                            </div>
                        </div>
                        <p>Already have an account?<a href="signin.html" style="text-decoration:none;">Sign in</a></p>
                    </form>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\faaiz\athree\resources\views/sign_up.blade.php ENDPATH**/ ?>