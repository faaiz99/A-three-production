    ...
    <div class="row justify-content-center">
        ...
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              ...
              <p class="text-muted mb-4">{{ $services[0]->description }}</p>
            </div>
            <div>
        ...
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              ...
              <p class="text-muted mb-4">{{ $services[1]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
      ...
      <div class="col-md-4">
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              <h5 class="card-title">{{ $services[2]->title }}</h5>
              <p class="text-muted mb-4">{{ $services[2]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
    ...
    <div class="row justify-content-center">
        ...
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              ...
              <p class="text-muted mb-4">{{ $services[3]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
        ...
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              ...
              <p class="text-muted mb-4">{{ $services[4]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
      ...
      <div class="col-md-4">
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              <h5 class="card-title">{{ $services[5]->title }}</h5>
              <p class="text-muted mb-4">{{ $services[5]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
                <span>Photography</span><span>$999</span>
      ...
      <div class="col-md-4">
        <div class="card text-black">
          ...
          <div class="card-body">
            <div class="text-center">
              <h5 class="card-title">{{ $services[6]->title }}</h5>
              <p class="text-muted mb-4">{{ $services[6]->description }}</p>
            </div>
            <div>
              <div class="d-flex justify-content-between">
